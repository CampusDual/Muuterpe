...
export declare class OAppSidenavMenuGroupComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    static DEFAULT_INPUTS_O_APP_SIDENAV_MENU_GROUP: string[];
    static DEFAULT_OUTPUTS_O_APP_SIDENAV_MENU_GROUP: string[];
...
export declare class OAppSidenavMenuGroupModule {
}
