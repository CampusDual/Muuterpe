...
export declare class OTableButtonsComponent implements OnInit, OnDestroy {
    protected injector: Injector;
    protected table: OTableComponent;
    static DEFAULT_INPUTS_O_TABLE_BUTTONS: string[];
    static DEFAULT_OUTPUTS_O_TABLE_BUTTONS: any[];
