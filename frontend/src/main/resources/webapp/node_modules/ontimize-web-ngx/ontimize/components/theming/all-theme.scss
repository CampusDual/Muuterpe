...
@mixin o-breadcrumb-theme($theme) {
  $primary: map-get($theme, primary);
...
@mixin o-form-toolbar-theme($theme) {
  ...
  .o-form-toolbar-header {
    ...
    .mat-toolbar-tools .o-form-toolbar-button[disabled] {
...
@mixin o-dialog-theme($theme) {
  ...
  .mat-dialog {
    ...
    &.mat-content-overflow {
      .mat-actions, mat-dialog-actions {
...
@mixin o-table-size-typography($typography, $size) {
  ...
  .o-table .o-table-container {
    .mat-table.#{$size} {
      tr.mat-header-row:not(.o-table-insertable) {
      ...
      tr.o-table-insertable.mat-header-row{
        height: $row-height;
...
@mixin o-list-picker-theme($theme) {
  .o-list-picker-dialog mat-toolbar .o-list-picker-search {
    ...
    &.o-list-picker-search .mat-input-placeholder,
    .mat-icon {
      color: mat-color($primary, default-contrast);
    }

    &.o-list-picker-search .mat-input-underline {
  ...
  .o-app-sidenav {
    ...
    .o-app-sidenav-sidenav {
      ...
      .o-app-sidenav-item {
        ...
        .o-app-sidenav-viewer-sidenav-item-selected {
          color: mat-color($accent);
        }
...
@mixin o-card-menu-item-theme($theme) {
  $primary: map-get($theme, primary);
  $accent: map-get($theme, accent);
  $warn: map-get($theme, warn);
  $background: map-get($theme, background);
  ...
  .o-card-menu-item {
    ...
    border: 1px solid mat-color($primary, 0.17);
    ...
    .o-card-menu-item-info {
      color: mat-color($primary, 0.54);
    }

  }

}
@mixin o-hour-input-theme($theme) {
  $primary: map-get($theme, primary);

  div.o-table-cell-editor-time,
  o-hour-input.o-hour-input {
    .timepicker__header {
...
@mixin o-form-layout-tabgroup-theme($theme) {
  $background: map-get($theme, background);
...
@mixin o-material-theme($theme, $typography: null) {
  ...
  @include o-card-menu-item-theme($theme);
