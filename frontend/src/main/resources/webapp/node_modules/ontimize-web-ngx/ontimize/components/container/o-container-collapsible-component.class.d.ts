...
export declare class OContainerCollapsibleComponent extends OContainerComponent {
    protected form: OFormComponent;
    protected elRef: ElementRef;
    protected injector: Injector;
    protected matFormDefaultOption: any;
    static DEFAULT_INPUTS_O_CONTAINER_COLLAPSIBLE: string[];
    expanded: boolean;
    ...
    constructor(form: OFormComponent, elRef: ElementRef, injector: Injector, matFormDefaultOption: any);
