...
export declare class OAppSidenavMenuItemComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    static DEFAULT_INPUTS_O_APP_SIDENAV_MENU_ITEM: string[];
    static DEFAULT_OUTPUTS_O_APP_SIDENAV_MENU_ITEM: string[];
    ...
    protected setUserInfoImage(): void;
...
export declare class OAppSidenavMenuItemModule {
}
