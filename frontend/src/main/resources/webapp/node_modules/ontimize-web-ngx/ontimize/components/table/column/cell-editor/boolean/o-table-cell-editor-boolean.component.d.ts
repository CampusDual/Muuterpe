...
export declare class OTableCellEditorBooleanComponent extends OBaseTableCellEditor {
    protected injector: Injector;
    static DEFAULT_INPUTS_O_TABLE_CELL_EDITOR_BOOLEAN: string[];
    static DEFAULT_OUTPUTS_O_TABLE_CELL_EDITOR_BOOLEAN: string[];
