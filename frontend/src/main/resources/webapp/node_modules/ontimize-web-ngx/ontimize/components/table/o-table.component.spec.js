...
describe('OTableComponent', function () {
    ...
    it('should create the component', async(function () {
        var fixture = TestBed.createComponent(OTableComponent);
        console.log(fixture);
    }));
});
//# sourceMappingURL=o-table.component.spec.js.map