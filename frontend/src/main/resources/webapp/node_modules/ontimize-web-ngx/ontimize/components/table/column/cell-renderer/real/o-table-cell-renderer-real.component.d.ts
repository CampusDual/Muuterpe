...
export declare class OTableCellRendererRealComponent extends OTableCellRendererIntegerComponent {
    protected injector: Injector;
    static DEFAULT_INPUTS_O_TABLE_CELL_RENDERER_REAL: string[];
