...
export declare class OFormLayoutManagerComponent implements AfterViewInit, OnInit, OnDestroy, ILocalStorageComponent {
    ...
    static DEFAULT_INPUTS_O_FORM_LAYOUT_MANAGER: string[];
    static DEFAULT_OUTPUTS_O_FORM_LAYOUT_MANAGER: string[];
    ...
    dialogClass: string;
    oTabGroup: OFormLayoutTabGroupComponent;
    ...
    openFormLayoutDialog(detailComp: IDetailComponentData): void;
