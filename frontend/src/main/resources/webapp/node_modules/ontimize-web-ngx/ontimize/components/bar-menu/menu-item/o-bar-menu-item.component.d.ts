...
export declare class OBarMenuItemComponent extends OBaseMenuItemClass {
    protected menu: OBarMenuComponent;
    protected elRef: ElementRef;
    protected injector: Injector;
    static DEFAULT_INPUTS_O_BAR_MENU_ITEM: string[];
...
export declare class OBarMenuItemModule {
}
