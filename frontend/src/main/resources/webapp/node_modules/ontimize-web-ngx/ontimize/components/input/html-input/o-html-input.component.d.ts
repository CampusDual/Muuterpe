...
export declare class OHTMLInputComponent extends OFormDataComponent implements AfterViewInit {
    static DEFAULT_INPUTS_O_HTML_INPUT: string[];
    static DEFAULT_OUTPUTS_O_HTML_INPUT: string[];
