...
export declare type OTableColumnsFilterMode = 'default' | 'selection' | 'custom';
export declare class OTableColumnsFilterComponent implements OnInit {
    protected injector: Injector;
    protected table: OTableComponent;
    static DEFAULT_INPUTS_O_TABLE_COLUMN_FILTER: string[];
    static DEFAULT_OUTPUTS_O_TABLE_COLUMN_FILTER: any[];
