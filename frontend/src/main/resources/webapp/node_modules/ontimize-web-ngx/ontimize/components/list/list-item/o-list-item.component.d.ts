import { AfterContentInit, ElementRef, Injector, QueryList, Renderer2 } from '@angular/core';
import { MatLine, MatListAvatarCssMatStyler, MatListItem } from '@angular/material';
import { OListComponent } from '../o-list.component';
export declare class OListItemComponent implements AfterContentInit {
    elRef: ElementRef;
...
export declare class OListItemModule {
}
