...
import { DateFilterFunction, ODateValueType } from '../../../../input/date-input/o-date-input.component';
...
export declare class OTableCellEditorDateComponent extends OBaseTableCellEditor implements OnInit {
    ...
    static DEFAULT_INPUTS_O_TABLE_CELL_EDITOR_DATE: string[];
    static DEFAULT_OUTPUTS_O_TABLE_CELL_EDITOR_DATE: string[];
